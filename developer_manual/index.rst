...
| testing team                |                                            |                                                |
+-----------------------------+--------------------------------------------+------------------------------------------------+
|:doc:`commun/index`          | :doc:`mobile_development/ios_library/index`|:doc:`mobile_development/android_library/index` |
| Help on IRC, the            |  Integration with iOS                      | Integrating with Android                       |
| mailinglist and forum       |                                            |                                                |
+-----------------------------+--------------------------------------------+------------------------------------------------+

.. _ownCloud Marketplace: https://marketplace.owncloud.com/

...
Before you start, please check if there already is a similar app to contribute to in `the App Store <http://apps.owncloud.com>`_, or in the :doc:`official_owncloud_apps`. Also, feel free to communicate your idea and plans to the `user mailing list <http://mailman.owncloud.org/mailman/listinfo/user>`_ or `developer mailing list <http://mailman.owncloud.org/mailman/listinfo/devel>`_ so other contributors might join in.

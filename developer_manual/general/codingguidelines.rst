...
To check your PHP codestyle use `PHP Code Sniffer <https://github.com/squizlabs/PHP_CodeSniffer>`_ with the ``phpcs.xml`` config file from the core branch. e.g. ``phpcs --standard=./phpcs.xml yourCode.php``

...
* All fixes and new features are always developed in a branch and only merged to master once they are fully done, tested thoroughly, and received thumbs up from 2 reviewers.
...
* It is best to start working based on an issue - create one if there is none to make a proper plan and design. You describe what you want to do, ask feedback on the direction you take it and take it from there.

...
First `set up your web server and database <http://doc.owncloud.org/server/6.0/admin_manual/installation/installation_source.html>`_ (**Section**: Manual Installation - Prerequisites).

...
groups**, but mainly they are enabled or disabled on the Apps page, and are 
configured on your ownCloud Admin page, Personal page, or in ``config.php``.
...
You can view new, unreviewed and unstable applications in the 
...
3. Read about any of the apps in the ownCloud Apps Store and download any that 
   you like.
...
.. note:: If you would like to create or add your own ownCloud app, please use 
   ...
   the `App Development documentation 

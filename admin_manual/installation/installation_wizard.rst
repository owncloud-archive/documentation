...
in the Enterprise edition), and it is good only for testing and lightweight single-user setups
without client synchronization. Supported databases are MySQL, MariaDB,
...
must be installed before you run the Installation Wizard. When you 

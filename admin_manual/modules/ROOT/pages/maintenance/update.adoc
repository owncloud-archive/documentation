...
image:/owncloud-docs/_images/upgrade-2.png[image]
...
If the update fails, then you must update manually. (See Manually 
...
the strong directory permissions <post_installation_steps_label>
immediately.
...
Please replace `Enter a random password here` with your own. Then add
this into your config.php:

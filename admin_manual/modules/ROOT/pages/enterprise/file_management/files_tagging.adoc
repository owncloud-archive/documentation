...
See
https://doc.owncloud.com/server/latest/user_manual/files/access_webgui.html[Tagging
Files] in the ownCloud User manual to learn how to apply and filter tags
on files.
...
image:/owncloud-docs/_images/workflow-1.png[image]
...
image:/owncloud-docs/_images/workflow-5.png[image]
...
image:/owncloud-docs/_images/workflow-4.png[image]

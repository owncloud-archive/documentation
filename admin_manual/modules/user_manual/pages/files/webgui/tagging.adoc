...
image:/owncloud-docs/_images/file_popup-menu.png[image]
...
image:/owncloud-docs/_images/files_page-7.png[image]
...
image:/owncloud-docs/_images/files_page-8.png[image]

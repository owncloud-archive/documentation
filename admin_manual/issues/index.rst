...
.. _bugtracker: http://doc.owncloud.org/server/6.0/developer_manual/bugtracker/index.html
...
you need to raise the log level to ``All`` from the Admin page. Please see :doc:`../configuration/configuration_logging`
...
* ``SQLSTATE[HY000]: General error: 5 database is locked`` -> You're using ``SQLite``
  which can't handle a lot of parallel requests. Please consider upgrading your
  installation to a newer ownCloud version to be able to migrate to MySQL or PostgreSQL.

...
* The WebDAV endpoint was changed from /remote.php/webdav to /remote.php/dav. You need to check your Apache configuration if you have execeptions or rules for WebDAV configured.

...
*   Remote subfolder -- The subfolder inside the Samba share to mount (optional, defaults to 
    ``/``)
...
*   Remote subfolder -- The remote folder you want to mount (optional, defaults 
    to ``/``)

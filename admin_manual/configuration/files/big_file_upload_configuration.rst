...
``tempdirectory`` setting in your ``config.php`` (See :doc:`../../configuration/server/config_sample_php_parameters`).

If you have configured the ``session_lifetime`` setting in your ``config.php``
(See :doc:`../../configuration/server/config_sample_php_parameters`) file then 

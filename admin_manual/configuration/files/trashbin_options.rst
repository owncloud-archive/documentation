...
See the **Deleted Files** section in :doc:`../../configuration/server/config_sample_php_parameters`, and the :ref:`trashbin_label` section of :doc:`../../configuration/server/occ_command`.

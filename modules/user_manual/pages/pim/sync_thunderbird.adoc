...
image:/owncloud-docs/_images/contact_thunderbird-Symbol_Gear.jpg[image]
...
image:/owncloud-docs/_images/contact_thunderbird-Symbol_Impeller.jpg[image]

which will display the URL you need for your installation to work.

image:/owncloud-docs/_images/contact_thunderbird-URL_config.jpg[image]

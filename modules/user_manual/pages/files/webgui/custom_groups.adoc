...
image:/owncloud-docs/_images/custom-groups/owncloud-create-custom-group-annotated.png[The Custom Groups administration panel]
...
image:/owncloud-docs/_images/custom-groups/custom-group-manage-group-members.png[Manage members in a custom group]
...
image:/owncloud-docs/_images/custom-groups/owncloud-share-to-custom-group.png[Sharing files and folders with custom groups]
...
image:/owncloud-docs/_images/custom-groups/rename-custom-group.png[Rename a custom group]

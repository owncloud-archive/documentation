...
image:/owncloud-docs/user_manual/_images/gallery-1.png[image]
...
image:/owncloud-docs/user_manual/_images/gallery-2.png[image]
...
home icon. (This puts it in `data/<user>/files/`.) See an example below 

...
image:/owncloud-docs/_images/enterprise/external_storage/ldap-home-connector-1.png[LDAP Home Connector configuration.]
...
image:/owncloud-docs/_images/enterprise/external_storage/ldap-home-connector-2.png[Active Directory Attribute editor.]

Scroll to the attribute being used (UserSharedFolder in this instance),
and click *Edit*. Enter the users home directory.

image:/owncloud-docs/_images/enterprise/external_storage/ldap-home-connector-3.png[Editing the LDAP attribute.]

...
image:/owncloud-docs/_images/issues/code-integrity-notification.png[Code integrity warning banner.]
...
image:/owncloud-docs/_images/issues/code-integrity-admin.png[Links for resolving code integrity warnings.]
...
See ../configuration/server/occ_command to learn more about using `occ`.

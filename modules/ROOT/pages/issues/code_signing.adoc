...
image:/owncloud-docs/_images/code-integrity-notification.png[Code integrity warning banner.]
...
image:/owncloud-docs/_images/code-integrity-admin.png[Links for resolving code integrity warnings.]

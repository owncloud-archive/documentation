...
image:/owncloud-docs/_images/custom-groups/customgroup.png[Configuration for ownCloud admins]

As an ownCloud admin, you can enable/disable these two options for custom groups.

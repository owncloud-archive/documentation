...
* link:list-tags[List tags]
* link:create-tags[Create tags]
* link:update-tags[Update tags]
* link:delete-tags[Delete tags]
* link:retrieve-the-tag-ids-and-metadata-of-a-given-file[Retrieve-the-tag-ids-and-metadata-of-a-given-file]
* link:assign-a-tag-to-a-file[Assign-a-tag-to-a-file]
* link:unassign-a-tag-from-a-file[Un-assign-a-tag-from-a-file]
* link:create-and-assign-a-tag-at-the-same-time[Create-and-assign-a-tag-at-the-same-time]
* link:retrieve-all-files-tagged-with-a-tag-id[Retrieve-all-files-tagged-with-a-tag-id]

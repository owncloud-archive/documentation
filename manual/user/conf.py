...
shared_assets_base_dir = '../../_shared_assets/'
...
templates_path = [shared_assets_base_dir + 'templates']
...
html_theme_path = [shared_assets_base_dir + 'themes']
...
html_static_path = [shared_assets_base_dir + 'static']
...
# the title page.
latex_logo = shared_assets_base_dir + 'static/logo-blue.pdf'
